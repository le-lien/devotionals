...
# Your mapping
book_map <- c(
  "Genesis"="GEN","Exodus"="EXO","Exod"="EXO","Leviticus"="LEV","Numbers"="NUM","Deuteronomy"="DEU","Deu"="DEU",
  "Joshua"="JOS","Judges"="JDG","Ruth"="RUT",
  "1 Samuel"="1SA","2 Samuel"="2SA",
  "1 Kings"="1KI","2 Kings"="2KI",
  "1 Chronicles"="1CH","2 Chronicles"="2CH","2 Chron"="2CH",
  "Ezra"="EZR","Nehemiah"="NEH","Esther"="EST",
  "Job"="JOB","Psalm"="PSA","Ps"="PSA","Psalms"="PSA","Proverbs"="PRO","Ecclesiastes"="ECC","Song of Solomon"="SNG","Song"="SNG",
  "Isaiah"="ISA", "Isa"="ISA","Isa=ISA","Jeremiah"="JER","Jer"="JER","Lamentations"="LAM","Ezekiel"="EZK","Daniel"="DAN",
  ...
  "Galatians"="GAL","Gal"="GAL","Ephesians"="EPH","Philippians"="PHP","Phil"="PHP","Colossians"="COL","Col"="COL",
  "1 Thessalonians"="1TH", "1 Thess"="1TH","2 Thessalonians"="2TH",
  "1 Timothy"="1TI","2 Timothy"="2TI","2 Tim"="2TI","Titus"="TIT","Philemon"="PHM","HEBREWS"="HEB",
