...
book_map <- c(
  ...
  "Isaiah"="ISA","Isa=ISA","Jeremiah"="JER","Jer"="JER","Lamentations"="LAM","Ezekiel"="EZK","Daniel"="DAN",
  ...
  "Galatians"="GAL","Gal"="GAL","Ephesians"="EPH","Philippians"="PHP","Phil"="PHP","Colossians"="COL",
